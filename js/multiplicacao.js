...
document.write("<h1 class='subtitle'>X</h1><br>");
...
mResultado2x2[0] = [];
mResultado2x2[1] = [];                                                              //CALCULO TABELA 2X2

mResultado2x2[0][0] = m2x21[0][0] * m2x22[0][0] + m2x21[0][1] * m2x22[1][0];
mResultado2x2[0][1] = m2x21[0][0] * m2x22[0][1] + m2x21[0][1] * m2x22[1][1];

mResultado2x2[1][0] = m2x21[1][0] * m2x22[0][0] + m2x21[1][1] * m2x22[1][0];
mResultado2x2[1][1] = m2x21[1][0] * m2x22[0][1] + m2x21[1][1] * m2x22[1][1];
...
document.write("<div id='tabela-container-1'><table class='table-edit'>"); //CRIACAO TABELA 3x3 - 1
...
mResultado3x3[0] = [];
mResultado3x3[1] = [];
mResultado3x3[2] = [];                                                           //CALCULO TABELA 3X3

mResultado3x3[0][0] = m3x31[0][0] * m3x32[0][0] + m3x31[0][1] * m3x32[1][0] + m3x31[0][2] * m3x32[2][0]; //CERTO
mResultado3x3[0][1] = m3x31[0][0] * m3x32[0][1] + m3x31[0][1] * m3x32[1][1] + m3x31[0][2] * m3x32[2][1]; //CERTO
mResultado3x3[0][2] = m3x31[0][0] * m3x32[0][2] + m3x31[0][1] * m3x32[1][2] + m3x31[0][2] * m3x32[2][2]; //CERTO

mResultado3x3[1][0] = m3x31[1][0] * m3x32[0][0] + m3x31[1][1] * m3x32[1][0] + m3x31[1][2] * m3x32[2][0]; //CERTO
mResultado3x3[1][1] = m3x31[1][0] * m3x32[0][1] + m3x31[1][1] * m3x32[1][1] + m3x31[1][2] * m3x32[2][1]; //CERTO
mResultado3x3[1][2] = m3x31[1][0] * m3x32[0][2] + m3x31[1][1] * m3x32[1][2] + m3x31[1][2] * m3x32[2][2]; //CERTO

mResultado3x3[2][0] = m3x31[2][0] * m3x32[0][0] + m3x31[2][1] * m3x32[1][0] + m3x31[2][2] * m3x32[2][0]; //CERTO
mResultado3x3[2][1] = m3x31[2][0] * m3x32[0][1] + m3x31[2][1] * m3x32[1][1] + m3x31[2][2] * m3x32[2][1]; //CERTO
mResultado3x3[2][2] = m3x31[2][0] * m3x32[0][2] + m3x31[2][1] * m3x32[1][2] + m3x31[2][2] * m3x32[2][2]; //CERTO

document.write("<br><div id='tabela-container-1'><table class='table-edit'>"); //CRIACAO TABELA 3x3 - RESULTADO
for (var i = 0; i < m3x32.length; i++) {
    document.write("<tr>");
    for (var c = 0; c < m3x32[1].length; c++) {
...
document.write("</table></div>");
document.write("<div class='espaco-cima'><br>");